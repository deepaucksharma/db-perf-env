...
GRANT USAGE ON SCHEMA app TO ${POSTGRES_MONITOR_USER};
GRANT SELECT ON ALL TABLES IN SCHEMA app TO ${POSTGRES_MONITOR_USER};
GRANT EXECUTE ON ALL FUNCTIONS IN SCHEMA app TO ${POSTGRES_MONITOR_USER};
GRANT USAGE ON ALL SEQUENCES IN SCHEMA app TO ${POSTGRES_MONITOR_USER};
GRANT pg_monitor TO ${POSTGRES_MONITOR_USER};

-- Grant select on pg_stat_statements to newrelic user
GRANT SELECT ON pg_stat_statements TO ${POSTGRES_MONITOR_USER};
